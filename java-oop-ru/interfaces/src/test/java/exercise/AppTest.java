...
class AppTest {
    private static ReversedSequence reverseText = new ReversedSequence("abcdef");
    ...
    public void testToString() {
        String expectedValue = "fedcba";
        assertEquals(reverseText.getSequence(), expectedValue);
    }

    @Test
    public void testCharAt() {
        char expectedValue = 'e';
        assertEquals(reverseText.charAt(1), expectedValue);
    }

    @Test
    public void testLength() {
        int expectedValue = 6;
        assertEquals(reverseText.length(), expectedValue);
    }

    @Test
    public void testSubSequence() {
        String expectedValue = "edc";
        assertEquals(reverseText.subSequence(1, 4), expectedValue);
    }
    // END
}
