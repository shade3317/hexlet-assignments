...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        MockHttpServletResponse responsePost = mockMvc
                .perform(
                        patch("/people/1")
                                ...
                                .content("{\"firstName\": \"Sam\", \"lastName\": \"Winchester\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Sam", "Winchester");
    ...
    void testCreatePerson() throws Exception {
        MockHttpServletResponse responsePost = mockMvc
            .perform(
                post("/people")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content("{\"firstName\": \"Dean\", \"lastName\": \"Winchester\"}")
            )
            .andReturn()
            .getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Dean", "Winchester");
    }
}
